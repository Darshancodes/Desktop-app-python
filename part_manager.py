...
# Part
part_text = StringVar()
part_label = Label(app, text='Screen Name', font=('bold', 14), pady=20)
...
# Buttons
add_btn = Button(app, text='Add Screens', width=12, command=add_item)
add_btn.grid(row=2, column=0, pady=20)

remove_btn = Button(app, text='Remove Screens', width=12, command=remove_item)
remove_btn.grid(row=2, column=1)

update_btn = Button(app, text='Update Screens', width=12, command=update_item)
update_btn.grid(row=2, column=2)

clear_btn = Button(app, text='Clear Input', width=12, command=clear_text)
clear_btn.grid(row=2, column=3)

app.title('Screens Manager')
